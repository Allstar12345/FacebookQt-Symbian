...
**
** Created: Mon 9. Dec 23:14:51 2013
...
static const char qt_meta_stringdata_Capturer[] = {
    "Capturer\0\0obj\0save(QDeclarativeItem*)\0"
};

const QMetaObject Capturer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Capturer,
      qt_meta_data_Capturer, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Capturer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Capturer))
...
int Capturer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: save((*reinterpret_cast< QDeclarativeItem*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
