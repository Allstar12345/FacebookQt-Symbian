...
import "Component"
Rectangle {
    QtObject { id: creator; property Component com: null;function createComponent (qmlfile){com = Qt.createComponent(qmlfile);com.createObject(mobilepage)} }
    anchors.fill: parent
    color: platformInverted? "white": "black"
    id: mobilepage
    property string fontSize:appSettings.getSystemSetting("fontsize", "")
    property string webImage: ""
    ...
    function openShortcuts(){
      creator.createComponent("Component/MobileShortcutsPopup.qml")
    }
    function openNCI(){
    ...
    function openmenu(){
      creator.createComponent("Component/MobileMenu.qml")
    }
        ...
        WebViewCustom {
          ...
          /*  javaScriptWindowObjects: QtObject {
            ...
            onLoadStarted: { if(checkStatus==="failed"){if (!__check) __check = Qt.createComponent("RunCheck.qml")
                   ...
                   }web_view1.evaluateJavaScript("var inputs = document.getElementsByTagName('INPUT');var index;for(index=0; index < inputs.length; index++){inputs[index].onfocus = function() {window.qml.showKeyboard()};inputs[index].onblur = function() {window.qml.hideKeyboard()}}");appSettings.saveSystemSetting("url", web_view1.url);fadingloader.start() }
            onLoadFinished: {
